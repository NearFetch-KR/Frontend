        ...
        <div class="section headerwrapper">
            <div class="InfoLogo">
                <div class="InfoMenu">
                        ...
                        <form action="" class="login">
                            ...
                            <div class="loginInfoWrapper">
                                <div class="inputWrapper">
                                    <label for="mail">이메일 주소</label><br/>
                            ...
                            <div class="btnWrapper">
                                ...
                                <button class="kakaoLogin" onclick="kakaoLogin();">카카오톡으로 로그인</button>
                    ...
                    <div id="registerModal">
                        <div class="modal-content" include-html="/component/register.html"></div>
                    </div>

                    <button id="myInfo">내정보</button>
                    <button id="myCart" onclick="location.href='../myinfoAll/add.html'">장바구니</button>
                </div>
            ...
            <div class="itemCategory">
                ...
                <div class="topnav" id="myTopnav">
                        ...
                        <div class="dropdown-content">
                            <div class="categoryMedium">
                                <a href="#">clothing</a>
                                    <ul>
                                        ...
                                        <li><a href="">lingerie & swimwear</a></li>
                            ...
                            <div class="categoryMedium">
                                ...
                                <ul>
                                    ...
                                    <li><a href="">hats</a></li>
                                    <li><a href="">scarves & foulards</a></li>
                    ...
                    <a href="javascript:void(0);"  class="icon" onclick="spreadNavbar()">&#9776;</a>
                </div>
