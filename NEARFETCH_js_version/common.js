...
// keyword_default.addEventListener("submit", goSearch);
...
window.onload = function () {
  ...
  mailRegister.addEventListener("click", (e) => {
    ...
    fetch("http://172.20.10.6:8000/users/signup", {
      method: "POST",
      headers: {
  ...
  logoutBtn.addEventListener("click", (e) => {
    ...
    fetch("http://172.20.10.6:8000/users/logout", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
if (
  ...
  fetch("http://172.20.10.6:8000/products/list", {
    ...
    .then((response) => {
      ...
      fetch(`http://172.20.10.6:8000/products/detail/${skuNum}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      // 하단 추천상품 가져오기
      fetch(`http://172.20.10.6:8000/products/recommend?skuNum=${skuNum}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
        ...
        .then((response) => {
          ...
          RecomItem__img.forEach((el, index) => {
            el.onclick = (e) => {
              ...
              let itemBrand =
                parentTag.parentElement.childNodes[1].childNodes[0].innerText;
              let itemName =
                parentTag.parentElement.childNodes[1].childNodes[1].innerText;
              let price =
                parentTag.parentElement.childNodes[1].childNodes[2].innerText;
              let sale_price =
                parentTag.parentElement.childNodes[1].childNodes[3].innerText;
              let skuNum =
                parentTag.parentElement.childNodes[1].childNodes[4].innerText;
              let itemOption =
                parentTag.parentElement.childNodes[1].childNodes[5].innerText;
              let materials =
                parentTag.parentElement.childNodes[1].childNodes[6].innerText;
              ...
              fetch(`http://172.20.10.6:8000/products/detail/${skuNum}`, {
                ...
                .then((response) => {
                  ...
                  //우//상품정보
                  document.querySelector(".itemBuy .itemBrand").textContent =
                    response.result.itemBrand;
                  ...
                  document.querySelector(".itemBuy .sale_price").textContent =
                    response.result.sale_price;
                  document.querySelector(".itemBuy .materials").textContent =
...
//     fetch(`http://172.20.10.6:8000/products/detail/${sku_number}`, {
//         method: "GET",
//         headers: {
//             "Content-Type": "application/json",
//         },
...
//         fetch(`http://172.20.10.6:8000/products/list?large_category=${gender}&medium_category=${categoryMedium}&small_category=${categorySmall}`, {
//             method: "GET",
//             headers: {
//                 "Content-Type": "application/json",
//             },
...
saveAddressBtn.addEventListener("click", (e) => {
  ...
  let token = localStorage.getItem("login-token");
  fetch("http://172.20.10.6:8000/users/register/location", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Authorization: token,
